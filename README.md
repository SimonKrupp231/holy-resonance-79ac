...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/holy-resonance-79ac)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/holy-resonance-79ac
```

A live public deployment of this template is available at [https://holy-resonance-79ac.templates.workers.dev](https://holy-resonance-79ac.templates.workers.dev)
